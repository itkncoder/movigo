            ...
            <div className="mt-12 lg:mt-20 sm:ml-5 ml-2 flex w-full justify-between items-end">
                <div className="mt-24 flex flex-col items-start gap-2">
                    <div className="flex flex-col gap-1.5 lg:gap-0">
                        <h1 className="bebas home-top-type text-4xl"><i className="fa-solid fa-fire-flame-curved"></i> {props.filmType}</h1>
                        <h1 className="home-top-name text-5xl md:text-6xl lg:text-7xl md:max-w-lg">{props.title}</h1>
