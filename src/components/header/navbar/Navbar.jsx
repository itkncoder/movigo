...
const Navbar = () => {
    ...
    return (  
        <>
            <nav ref={nav} className="ml-32 flex hidden fixed md:static md:flex bg-gray-900 z-40 md:bg-transparent rounded-2xl md:h-fit h-screen p-12 right-0 top-0 w-full md:w-fit">
                <ul onClick={() => {
